...
-- 1. Core ITSM Modules
('PERM_001', 'incidents', 'crud'),
('PERM_002', 'problems', 'crud'),
('PERM_003', 'changes', 'crud'),
('PERM_004', 'users', 'crud'),
('PERM_005', 'configuration_items', 'crud'),
('PERM_006', 'services', 'crud'),
('PERM_007', 'knowledge_articles', 'crud'),
('PERM_008', 'locations', 'crud'),
('PERM_009', 'sla_definitions', 'crud'),

-- 2. User & Group Management
('PERM_010', 'user_groups', 'crud'),
('PERM_011', 'user_group_members', 'crud'),
('PERM_012', 'user_roles', 'crud'),

-- 3. Service Level & Templates
('PERM_013', 'service_offerings', 'crud'),
('PERM_014', 'incident_templates', 'crud'),

-- 4. Incident Sub-tables & Mappings
('PERM_015', 'child_incidents', 'crud'),
('PERM_016', 'incident_affected_cis', 'crud'),
('PERM_017', 'incident_slas', 'crud'),
('PERM_018', 'incident_knowledge_articles', 'crud'), 
-- Attached knowledge to incidents

-- 5. Change Management Mappings
('PERM_019', 'change_request_mappings', 'crud'),

-- 6. System & Organization
('PERM_020', 'notifications', 'crud'),
('PERM_021', 'organizations', 'crud'),

-- 7. RBAC Metadata (System Security)
('PERM_022', 'roles', 'crud'),
('PERM_023', 'permissions', 'crud');


-- Inserting the 4 Core Roles
...
-- ==================================================================================
-- 1. ADMIN (ROLE_001)
-- Has access to everything (PERM_001 to PERM_023)
-- ==================================================================================
('ROLE_001', 'PERM_001'),
--incidents
('ROLE_001', 'PERM_002'),
...
--incident_slas
('ROLE_001', 'PERM_018'),
--incident_knowledge_articles
('ROLE_001', 'PERM_019'),
--change_request_mappings
('ROLE_001', 'PERM_020'),
--notifications
('ROLE_001', 'PERM_021'),
--organizations
...
-- ==================================================================================
-- 2. AGENT (ROLE_002)
-- Core operational access: Incidents, Problems, Changes, CIs, Knowledge, and their sub-tables
-- ==================================================================================
('ROLE_002', 'PERM_001'),
--incidents
('ROLE_002', 'PERM_002'),
...
-- ==================================================================================
-- 3. MANAGER (ROLE_003)
-- Inherits Agent access + User Management, Group Management, Service Design, Locations, SLAs
-- ==================================================================================
-- Manager Specific:
('ROLE_003', 'PERM_004'),
--users
...
-- Inherited Agent Access (Operational):
('ROLE_003', 'PERM_001'),
--incidents
('ROLE_003', 'PERM_002'),
--problems
...
-- ==================================================================================
-- 4. REPORTER (ROLE_004)
-- Basic access: Incidents, Knowledge Base, Services
-- ==================================================================================
('ROLE_004', 'PERM_001'),
--incidents
('ROLE_004', 'PERM_006'),
...
INSERT INTO user_group_member (member_id, group_id, user_id, created_on, updated_on) VALUES
-- 1. L1 IT Support (General Triage)
('MEM_001', 'GROUP_001', 'USER_001', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Thomas Green (Agent)
('MEM_002', 'GROUP_001', 'USER_005', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Mckenzie Mendez (Agent)
('MEM_003', 'GROUP_001', 'USER_011', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Travis Wood (Agent)
('MEM_004', 'GROUP_001', 'USER_012', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Samantha Stone (Agent)

-- 2. L2 IT Support (Escalations & Manager Oversight)
('MEM_005', 'GROUP_002', 'USER_004', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Joanne Simpson (Manager)
('MEM_006', 'GROUP_002', 'USER_006', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Stephanie Todd (Agent)
('MEM_007', 'GROUP_002', 'USER_009', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Steven Hernandez (Agent)

-- 3. L1 Service Desk (High Volume)
('MEM_008', 'GROUP_003', 'USER_003', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Tabitha Bullock (Agent)
('MEM_009', 'GROUP_003', 'USER_013', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Jonathan Martinez (Agent)
('MEM_010', 'GROUP_003', 'USER_015', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Diana Johnson (Agent)
('MEM_011', 'GROUP_003', 'USER_022', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--David Jones (Agent)
('MEM_012', 'GROUP_003', 'USER_023', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Kathleen Montgomery (Agent)

-- 4. L2 Service Desk (VIP Support)
('MEM_013', 'GROUP_004', 'USER_031', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Robin Monroe (Manager)
('MEM_014', 'GROUP_004', 'USER_024', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Eric Rodriguez (Agent)
('MEM_015', 'GROUP_004', 'USER_025', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Barbara Perry (Agent)

-- 5. L1 Field Support (Hardware)
('MEM_016', 'GROUP_005', 'USER_026', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Christine Torres (Agent)
('MEM_017', 'GROUP_005', 'USER_029', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Anne Medina (Agent)
('MEM_018', 'GROUP_005', 'USER_033', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Zachary Mcintosh (Agent)

-- 6. L2 Field Support (Advanced Hardware)
('MEM_019', 'GROUP_006', 'USER_037', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Randy Martinez (Manager)
('MEM_020', 'GROUP_006', 'USER_038', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Samuel Kemp (Agent)
('MEM_021', 'GROUP_006', 'USER_040', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Susan Adams (Agent)

-- 7. L1 Infra Team (Monitoring)
('MEM_022', 'GROUP_007', 'USER_042', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Elizabeth Gregory (Agent)
('MEM_023', 'GROUP_007', 'USER_043', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Lauren Clark (Agent)
('MEM_024', 'GROUP_007', 'USER_045', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Zachary Moore (Agent)
('MEM_025', 'GROUP_007', 'USER_046', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--April Knight (Agent)

-- 8. L2 Infra Team (Root Cause Analysis)
('MEM_026', 'GROUP_008', 'USER_049', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Cheryl Osborne (Manager)
('MEM_027', 'GROUP_008', 'USER_052', '2025-01-10 09:00:00', '2025-01-10 09:00:00'),
--Casey Green (Agent)
('MEM_028', 'GROUP_008', 'USER_054', '2025-01-10 09:00:00', '2025-01-10 09:00:00');
-- Teresa Gibson (Agent)
...
-- =========================================================
('CI_001', 'SAP-DB-01 (Oracle Database)', 'SRV-ORC-9981', 'USER_001', 'LOC_003', 'ORG_001', 'in_use', 15000.00, '2023-01-10 08:00:00', '2023-01-10 08:00:00'),
('CI_002', 'SAP-APP-01 (Application Server)', 'SRV-LNX-4421', 'USER_001', 'LOC_003', 'ORG_001', 'in_use', 12000.00, '2023-01-10 09:00:00', '2023-01-10 09:00:00'),
('CI_003', 'Email-Exch-01 (Exchange)', 'SRV-WIN-1122', 'USER_032', 'LOC_001', 'ORG_001', 'maintenance', 8500.00, '2023-01-12 10:00:00', '2024-01-05 14:30:00'),
('CI_004', 'Core-Switch-HQ (Cisco)', 'NET-CS-8899', 'USER_039', 'LOC_001', 'ORG_001', 'in_use', 25000.00, '2023-01-15 11:00:00', '2023-01-15 11:00:00'),
('CI_005', 'VPN-Gateway-Lon (Cisco ASA)', 'NET-FW-5500', 'USER_039', 'LOC_003', 'ORG_001', 'in_use', 18000.00, '2023-01-15 12:00:00', '2023-01-15 12:00:00'),
('CI_006', 'FileShare-01 (Windows Storage)', 'SRV-STO-7741', 'USER_041', 'LOC_002', 'ORG_001', 'in_use', 9000.00, '2023-02-01 09:00:00', '2023-02-01 09:00:00'),
('CI_007', 'AWS-US-East-Cluster', 'CLD-AWS-991', 'USER_001', 'LOC_001', 'ORG_001', 'in_use', 0.00, '2023-01-01 00:00:00', '2023-01-01 00:00:00'),
('CI_008', 'Azure-AD-Sync', 'CLD-AZR-772', 'USER_032', 'LOC_001', 'ORG_001', 'in_use', 0.00, '2023-01-01 00:00:00', '2023-01-01 00:00:00'),
('CI_009', 'VMWare-Host-05', 'SRV-VM-5511', 'USER_001', 'LOC_003', 'ORG_001', 'in_use', 11000.00, '2023-04-01 09:00:00', '2023-04-01 09:00:00'),
('CI_010', 'Linux-Web-01 (Apache)', 'SRV-WEB-101', 'USER_041', 'LOC_001', 'ORG_001', 'in_use', 6000.00, '2023-03-15 10:00:00', '2023-03-15 10:00:00'),
('CI_011', 'Linux-Web-02 (Apache)', 'SRV-WEB-102', 'USER_041', 'LOC_001', 'ORG_001', 'in_use', 6000.00, '2023-03-15 10:00:00', '2023-03-15 10:00:00'),
('CI_012', 'SQL-Cluster-Main', 'SRV-SQL-CL1', 'USER_001', 'LOC_003', 'ORG_001', 'in_use', 22000.00, '2023-02-10 11:00:00', '2023-02-10 11:00:00'),
('CI_013', 'Backup-Server-Tape', 'SRV-BKP-009', 'USER_050', 'LOC_005', 'ORG_001', 'maintenance', 5000.00, '2023-05-01 09:00:00', '2023-05-01 09:00:00'),
('CI_014', 'Load-Balancer-Ext (F5)', 'NET-LB-555', 'USER_039', 'LOC_003', 'ORG_001', 'in_use', 14000.00, '2023-06-01 09:00:00', '2023-06-01 09:00:00'),
('CI_015', 'DNS-Primary-01', 'SRV-DNS-001', 'USER_032', 'LOC_001', 'ORG_001', 'in_use', 4000.00, '2023-01-20 09:00:00', '2023-01-20 09:00:00'),
('CI_016', 'DNS-Secondary-02', 'SRV-DNS-002', 'USER_032', 'LOC_003', 'ORG_001', 'in_use', 4000.00, '2023-01-20 09:00:00', '2023-01-20 09:00:00'),
('CI_017', 'HR-System-Db', 'SRV-HR-DB1', 'USER_057', 'LOC_002', 'ORG_001', 'in_use', 13000.00, '2023-04-10 09:00:00', '2023-04-10 09:00:00'),
('CI_018', 'Finance-App-Server', 'SRV-FIN-AP1', 'USER_057', 'LOC_002', 'ORG_001', 'in_use', 12500.00, '2023-04-12 09:00:00', '2023-04-12 09:00:00'),
('CI_019', 'WiFi-Controller-HQ', 'NET-WIFI-01', 'USER_039', 'LOC_001', 'ORG_001', 'in_use', 8000.00, '2023-03-05 09:00:00', '2023-03-05 09:00:00'),
('CI_020', 'Security-Camera-Srv', 'SRV-SEC-CAM', 'USER_076', 'LOC_001', 'ORG_001', 'maintenance', 7500.00, '2023-03-10 09:00:00', '2024-01-15 08:00:00'),

-- =========================================================
-- 2. ACME INTERNAL DEVICES (Agents & Managers)
-- =========================================================
('CI_021', 'MacBook Pro 16 - Thomas Green', 'MBP-TG-2023', 'USER_001', 'LOC_001', 'ORG_001', 'in_use', 2800.00, '2023-03-01 09:00:00', '2023-03-01 09:00:00'),
('CI_022', 'Dell XPS 15 - Tabitha Bullock', 'DEL-TB-4451', 'USER_003', 'LOC_003', 'ORG_001', 'in_use', 2200.00, '2023-03-02 09:00:00', '2023-03-02 09:00:00'),
('CI_023', 'Lenovo ThinkPad - Joanne Simpson', 'LNV-JS-9912', 'USER_004', 'LOC_004', 'ORG_001', 'in_use', 1900.00, '2023-03-03 09:00:00', '2023-03-03 09:00:00'),
('CI_024', 'MacBook Air - Mckenzie Mendez', 'MBA-MM-7721', 'USER_005', 'LOC_005', 'ORG_001', 'in_use', 1500.00, '2023-03-04 09:00:00', '2023-03-04 09:00:00'),
('CI_025', 'Dell Latitude - Stephanie Todd', 'DEL-ST-1129', 'USER_006', 'LOC_001', 'ORG_001', 'in_use', 1200.00, '2023-12-02 09:00:00', '2023-12-02 09:00:00'),
('CI_026', 'HP EliteBook - Steven Hernandez', 'HP-SH-8821', 'USER_009', 'LOC_002', 'ORG_001', 'in_use', 1400.00, '2023-04-01 09:00:00', '2023-04-01 09:00:00'),
('CI_027', 'MacBook Pro 14 - Travis Wood', 'MBP-TW-9988', 'USER_011', 'LOC_001', 'ORG_001', 'in_use', 2400.00, '2023-04-05 09:00:00', '2023-04-05 09:00:00'),
('CI_028', 'Dell Precision - Samantha Stone', 'DEL-SS-4411', 'USER_012', 'LOC_002', 'ORG_001', 'in_use', 2600.00, '2023-04-06 09:00:00', '2023-04-06 09:00:00'),
('CI_029', 'Lenovo Carbon X1 - Jonathan Martinez', 'LNV-JM-1122', 'USER_013', 'LOC_003', 'ORG_001', 'in_use', 2100.00, '2023-04-07 09:00:00', '2023-04-07 09:00:00'),
('CI_030', 'Surface Pro - Diana Johnson', 'MS-DJ-5511', 'USER_015', 'LOC_004', 'ORG_001', 'in_use', 1300.00, '2023-04-08 09:00:00', '2023-04-08 09:00:00'),
('CI_031', 'Dell XPS 13 - David Jones', 'DEL-DJ-3311', 'USER_022', 'LOC_005', 'ORG_001', 'in_use', 1800.00, '2023-04-09 09:00:00', '2023-04-09 09:00:00'),
('CI_032', 'MacBook Air - Kathleen Montgomery', 'MBA-KM-2211', 'USER_023', 'LOC_001', 'ORG_001', 'maintenance', 1200.00, '2023-04-10 09:00:00', '2023-04-10 09:00:00'),
('CI_033', 'HP ZBook - Eric Rodriguez', 'HP-ER-9911', 'USER_024', 'LOC_002', 'ORG_001', 'in_use', 2300.00, '2023-04-11 09:00:00', '2023-04-11 09:00:00'),
('CI_034', 'Lenovo ThinkPad - Barbara Perry', 'LNV-BP-7711', 'USER_025', 'LOC_003', 'ORG_001', 'in_use', 1600.00, '2023-04-12 09:00:00', '2023-04-12 09:00:00'),
('CI_035', 'Dell Latitude - Christine Torres', 'DEL-CT-5511', 'USER_026', 'LOC_004', 'ORG_001', 'in_stock', 1200.00, '2023-04-13 09:00:00', '2023-04-13 09:00:00'),
--In Stock (Agent Inactive)
('CI_036', 'MacBook Pro 16 - Anne Medina', 'MBP-AM-4411', 'USER_029', 'LOC_005', 'ORG_001', 'in_use', 2800.00, '2023-04-14 09:00:00', '2023-04-14 09:00:00'),
('CI_037', 'Manager Tablet - Robin Monroe', 'TAB-RM-001', 'USER_031', 'LOC_001', 'ORG_001', 'in_use', 900.00, '2023-04-15 09:00:00', '2023-04-15 09:00:00'),
('CI_038', 'Dell Precision - Zachary Mcintosh', 'DEL-ZM-8811', 'USER_033', 'LOC_003', 'ORG_001', 'in_use', 2500.00, '2023-04-16 09:00:00', '2023-04-16 09:00:00'),
('CI_039', 'Manager Laptop - Randy Martinez', 'LNV-RM-002', 'USER_037', 'LOC_004', 'ORG_001', 'in_use', 2200.00, '2023-04-17 09:00:00', '2023-04-17 09:00:00'),
('CI_040', 'MacBook Pro 14 - Samuel Kemp', 'MBP-SK-1122', 'USER_038', 'LOC_005', 'ORG_001', 'in_use', 2400.00, '2023-04-18 09:00:00', '2023-04-18 09:00:00'),
('CI_041', 'Spare Agent Laptop 01', 'SPR-AGT-01', 'USER_031', 'LOC_001', 'ORG_001', 'in_stock', 1200.00, '2023-01-01 09:00:00', '2023-01-01 09:00:00'),
('CI_042', 'Spare Agent Laptop 02', 'SPR-AGT-02', 'USER_031', 'LOC_001', 'ORG_001', 'in_stock', 1200.00, '2023-01-01 09:00:00', '2023-01-01 09:00:00'),
('CI_043', 'Loaner Projector', 'LNR-PRJ-01', 'USER_004', 'LOC_001', 'ORG_001', 'in_use', 600.00, '2023-01-01 09:00:00', '2023-01-01 09:00:00'),
('CI_044', 'IT Testing Server', 'SRV-TST-001', 'USER_032', 'LOC_001', 'ORG_001', 'maintenance', 3000.00, '2023-01-01 09:00:00', '2023-01-01 09:00:00'),
('CI_045', 'IT Lab Switch', 'NET-LAB-001', 'USER_039', 'LOC_001', 'ORG_001', 'retired', 500.00, '2020-01-01 09:00:00', '2023-01-01 09:00:00'),

-- =========================================================
-- 3. CUSTOMER DEVICES (External Reporters)
-- =========================================================
('CI_046', 'HP EliteBook - Christina Oliver', 'HP-CO-002', 'USER_002', 'LOC_006', 'ORG_002', 'in_use', 1400.00, '2023-04-10 09:00:00', '2023-04-10 09:00:00'),
('CI_047', 'Dell Latitude - Denise Hawkins', 'DEL-DH-007', 'USER_007', 'LOC_007', 'ORG_003', 'in_use', 1200.00, '2023-04-12 09:00:00', '2023-04-12 09:00:00'),
('CI_048', 'Initech Workstation - James Hill', 'WS-JH-008', 'USER_008', 'LOC_008', 'ORG_004', 'in_use', 900.00, '2023-04-15 09:00:00', '2023-04-15 09:00:00'),
('CI_049', 'Secure Tablet - Brandon Davis', 'TAB-BD-010', 'USER_010', 'LOC_009', 'ORG_005', 'maintenance', 800.00, '2023-05-01 09:00:00', '2024-02-10 09:00:00'),
('CI_050', 'Developer Laptop - Kenneth Scott', 'DEV-KS-014', 'USER_014', 'LOC_010', 'ORG_006', 'in_use', 3200.00, '2023-05-05 09:00:00', '2023-05-05 09:00:00'),
('CI_051', 'Holographic Display - Meghan', 'HOL-MH-016', 'USER_016', 'LOC_011', 'ORG_007', 'in_use', 5000.00, '2023-05-10 09:00:00', '2023-05-10 09:00:00'),
('CI_052', 'Desktop PC - Terry Lopez', 'PC-TL-017', 'USER_017', 'LOC_013', 'ORG_008', 'retired', 1100.00, '2022-01-01 09:00:00', '2023-11-11 09:00:00'),
('CI_053', 'New Laptop - Terry Lopez', 'LAP-TL-017B', 'USER_017', 'LOC_013', 'ORG_008', 'in_use', 2100.00, '2023-11-12 09:00:00', '2023-11-12 09:00:00'),
('CI_054', 'Mobile Device - David Ramirez', 'MOB-DR-018', 'USER_018', 'LOC_014', 'ORG_009', 'in_use', 1000.00, '2023-05-15 09:00:00', '2023-05-15 09:00:00'),
('CI_055', 'HooliPhone Prototype - Angela', 'PH-AB-019', 'USER_019', 'LOC_015', 'ORG_010', 'in_use', 1500.00, '2023-06-01 09:00:00', '2023-06-01 09:00:00'),
('CI_056', 'Trading Terminal - Marc Henry', 'TRD-MH-020', 'USER_020', 'LOC_016', 'ORG_011', 'in_use', 4000.00, '2023-06-05 09:00:00', '2023-06-05 09:00:00'),
('CI_057', 'Compression Server - Andrew Bell', 'SRV-AB-021', 'USER_021', 'LOC_017', 'ORG_012', 'maintenance', 3000.00, '2023-06-10 09:00:00', '2024-01-01 09:00:00'),
('CI_058', 'Video Editing Rig - Ashley', 'VID-AK-027', 'USER_027', 'LOC_018', 'ORG_013', 'in_use', 6000.00, '2023-06-15 09:00:00', '2023-06-15 09:00:00'),
('CI_059', 'Replicant Scanner - Sharon Fields', 'REP-SF-028', 'USER_028', 'LOC_019', 'ORG_014', 'in_use', 8000.00, '2023-06-20 09:00:00', '2023-06-20 09:00:00'),
('CI_060', 'Lab Equipment Controller - Randy', 'LAB-RS-030', 'USER_030', 'LOC_020', 'ORG_015', 'maintenance', 15000.00, '2023-07-01 09:00:00', '2024-01-20 09:00:00'),
('CI_061', 'Testing Device - Amanda', 'TST-AH-034', 'USER_034', 'LOC_021', 'ORG_016', 'disposed', 500.00, '2022-06-01 09:00:00', '2023-01-01 09:00:00'),
('CI_062', 'Geiger Counter - David Ford', 'GEO-DF-035', 'USER_035', 'LOC_022', 'ORG_017', 'in_use', 1200.00, '2023-07-05 09:00:00', '2023-07-05 09:00:00'),
('CI_063', 'Xeno-Scanner - Douglas Morse', 'XEN-DM-036', 'USER_036', 'LOC_023', 'ORG_018', 'in_use', 5000.00, '2023-07-10 09:00:00', '2023-07-10 09:00:00'),
('CI_064', 'Surface Laptop - Lisa Foley', 'MS-LF-044', 'USER_044', 'LOC_006', 'ORG_002', 'in_use', 1500.00, '2023-07-12 09:00:00', '2023-07-12 09:00:00'),
('CI_065', 'Sales Tablet - Michael Ward', 'TAB-MW-047', 'USER_047', 'LOC_007', 'ORG_003', 'in_use', 800.00, '2023-07-15 09:00:00', '2023-07-15 09:00:00'),
('CI_066', 'Accounting PC - Zachary Davis', 'PC-ZD-048', 'USER_048', 'LOC_008', 'ORG_004', 'in_use', 1000.00, '2023-07-18 09:00:00', '2023-07-18 09:00:00'),
('CI_067', 'Lab Laptop - Steven Manning', 'LAP-SM-051', 'USER_051', 'LOC_009', 'ORG_005', 'in_use', 1800.00, '2023-07-20 09:00:00', '2023-07-20 09:00:00'),
('CI_068', 'AI Workstation - Jennifer Taylor', 'AI-JT-053', 'USER_053', 'LOC_010', 'ORG_006', 'maintenance', 5500.00, '2023-07-22 09:00:00', '2023-07-22 09:00:00'),
('CI_069', 'Design Mac - Bethany Barnes', 'MAC-BB-055', 'USER_055', 'LOC_011', 'ORG_007', 'in_use', 3500.00, '2023-07-25 09:00:00', '2023-07-25 09:00:00'),
('CI_070', 'Executive Laptop - Patrick Ross', 'LAP-PR-056', 'USER_056', 'LOC_013', 'ORG_008', 'in_use', 2800.00, '2023-07-28 09:00:00', '2023-07-28 09:00:00'),
('CI_071', 'Marketing iPad - Ian Johnson', 'TAB-IJ-058', 'USER_058', 'LOC_014', 'ORG_009', 'in_use', 900.00, '2023-08-01 09:00:00', '2023-08-01 09:00:00'),
('CI_072', 'Dev Server - Kristen Mitchell', 'SRV-KM-060', 'USER_060', 'LOC_015', 'ORG_010', 'retired', 4000.00, '2021-01-01 09:00:00', '2023-01-01 09:00:00'),
('CI_073', 'Forex Monitor - Emily Faulkner', 'MON-EF-061', 'USER_061', 'LOC_016', 'ORG_011', 'in_use', 600.00, '2023-08-05 09:00:00', '2023-08-05 09:00:00'),
('CI_074', 'Audio Mixer - Thomas Bailey', 'MIX-TB-063', 'USER_063', 'LOC_017', 'ORG_012', 'in_use', 1200.00, '2023-08-08 09:00:00', '2023-08-08 09:00:00'),
('CI_075', 'Camera Drone - Theresa Fisher', 'DRN-TF-064', 'USER_064', 'LOC_018', 'ORG_013', 'maintenance', 2500.00, '2023-08-10 09:00:00', '2023-08-10 09:00:00'),
('CI_076', 'Bio-Scanner - Robyn Jacobs', 'SCN-RJ-069', 'USER_069', 'LOC_019', 'ORG_014', 'in_use', 9000.00, '2023-08-12 09:00:00', '2023-08-12 09:00:00'),
('CI_077', 'Chem-Analyzer - Nathan Scott', 'CHM-NS-070', 'USER_070', 'LOC_020', 'ORG_015', 'in_use', 11000.00, '2023-08-15 09:00:00', '2023-08-15 09:00:00'),
('CI_078', 'Portal Gun Prototype - Zachary Garcia', 'PG-ZG-071', 'USER_071', 'LOC_021', 'ORG_016', 'in_stock', 0.00, '2023-08-18 09:00:00', '2023-08-18 09:00:00'),
('CI_079', 'Rad-Suit - Austin Tran', 'SUIT-AT-073', 'USER_073', 'LOC_022', 'ORG_017', 'in_use', 500.00, '2023-08-20 09:00:00', '2023-08-20 09:00:00'),
('CI_080', 'Motion Tracker - Kayla Lutz', 'TRK-KL-074', 'USER_074', 'LOC_023', 'ORG_018', 'in_use', 1200.00, '2023-08-22 09:00:00', '2023-08-22 09:00:00'),
('CI_081', 'Backup Laptop - Hannah Gallagher', 'LAP-HG-077', 'USER_077', 'LOC_006', 'ORG_002', 'in_stock', 1000.00, '2023-08-25 09:00:00', '2023-08-25 09:00:00'),
('CI_082', 'Reception PC - Michelle Smith', 'PC-MS-078', 'USER_078', 'LOC_007', 'ORG_003', 'in_use', 900.00, '2023-08-28 09:00:00', '2023-08-28 09:00:00'),
('CI_083', 'Warehouse Scanner - Theresa Miller', 'SCN-TM-079', 'USER_079', 'LOC_008', 'ORG_004', 'in_use', 1500.00, '2023-08-30 09:00:00', '2023-08-30 09:00:00'),
('CI_084', 'Research Tab - Carl Brown', 'TAB-CB-082', 'USER_082', 'LOC_009', 'ORG_005', 'in_use', 700.00, '2023-09-01 09:00:00', '2023-09-01 09:00:00'),
('CI_085', 'Neural Net Srv - Alex Johnson', 'SRV-AJ-085', 'USER_085', 'LOC_010', 'ORG_006', 'in_use', 15000.00, '2023-09-05 09:00:00', '2023-09-05 09:00:00'),
('CI_086', 'Arc Reactor Rep - Steven Nguyen', 'ARC-SN-086', 'USER_086', 'LOC_011', 'ORG_007', 'maintenance', 50000.00, '2023-09-10 09:00:00', '2023-09-10 09:00:00'),
('CI_087', 'Batmobile Diag - Nancy Mcneil', 'DIAG-NM-088', 'USER_088', 'LOC_013', 'ORG_008', 'in_use', 3000.00, '2023-09-12 09:00:00', '2023-09-12 09:00:00'),
('CI_088', 'Quantum Chip - Heather Ball', 'QCH-HB-090', 'USER_090', 'LOC_014', 'ORG_009', 'in_stock', 20000.00, '2023-09-15 09:00:00', '2023-09-15 09:00:00'),
('CI_089', 'VR Headset - Wyatt Moreno', 'VR-WM-094', 'USER_094', 'LOC_015', 'ORG_010', 'in_use', 800.00, '2023-09-18 09:00:00', '2023-09-18 09:00:00'),
('CI_090', 'Crypto Wallet - Erin Davis', 'HW-ED-097', 'USER_097', 'LOC_016', 'ORG_011', 'in_use', 200.00, '2023-09-20 09:00:00', '2023-09-20 09:00:00'),

-- =========================================================
-- 4. SHARED OFFICE EQUIPMENT (Printers, Kiosks, etc.)
-- =========================================================
('CI_091', 'Reception Printer - Globex', 'PRT-GLB-001', 'USER_044', 'LOC_006', 'ORG_002', 'in_use', 1200.00, '2023-02-01 09:00:00', '2023-02-01 09:00:00'),
('CI_092', 'Conference Polycom - Initech', 'PLY-INI-001', 'USER_008', 'LOC_008', 'ORG_004', 'in_use', 800.00, '2023-02-01 09:00:00', '2023-02-01 09:00:00'),
('CI_093', 'Lobby Kiosk - Wayne Ent', 'KSK-WAY-001', 'USER_017', 'LOC_013', 'ORG_008', 'in_use', 2500.00, '2023-02-01 09:00:00', '2023-02-01 09:00:00'),
('CI_094', 'Soylent Dispenser - Manufacturing', 'SOY-DSP-001', 'USER_007', 'LOC_007', 'ORG_003', 'maintenance', 5000.00, '2023-02-01 09:00:00', '2024-03-01 09:00:00'),
('CI_095', 'Production Server - Cyberdyne', 'SRV-CYB-001', 'USER_014', 'LOC_010', 'ORG_006', 'in_use', 50000.00, '2023-02-01 09:00:00', '2023-02-01 09:00:00'),
('CI_096', 'Main Printer - ACME HQ', 'PRT-ACME-01', 'USER_031', 'LOC_001', 'ORG_001', 'in_use', 1500.00, '2023-01-01 09:00:00', '2023-01-01 09:00:00'),
('CI_097', 'Guest WiFi AP - ACME HQ', 'WIFI-GST-01', 'USER_039', 'LOC_001', 'ORG_001', 'in_use', 800.00, '2023-01-01 09:00:00', '2023-01-01 09:00:00'),
('CI_098', 'Cafeteria POS - ACME HQ', 'POS-CAF-01', 'USER_041', 'LOC_001', 'ORG_001', 'maintenance', 1200.00, '2023-01-01 09:00:00', '2023-01-01 09:00:00'),
('CI_099', 'Badge Scanner - Main Entry', 'SEC-BDG-01', 'USER_076', 'LOC_001', 'ORG_001', 'in_use', 2000.00, '2023-01-01 09:00:00', '2023-01-01 09:00:00'),
('CI_100', 'Datacenter HVAC Controller', 'HVAC-DC-01', 'USER_059', 'LOC_003', 'ORG_001', 'in_use', 10000.00, '2023-01-01 09:00:00', '2023-01-01 09:00:00');
...
-- =========================================================
('SLA_001', 'Priority 1 - Response', 'response', 15, FALSE, 'critical', TRUE, '24x7', 'ORG_001', '2023-01-01 00:00:00', '2023-01-01 00:00:00'),
('SLA_002', 'Priority 1 - Resolution', 'resolution', 240, TRUE, 'critical', TRUE, '24x7', 'ORG_001', '2023-01-01 00:00:00', '2023-01-01 00:00:00'),
--4 Hours

-- =========================================================
-- HIGH (Business Hours - 8am to 5pm)
-- =========================================================
('SLA_003', 'Priority 2 - Response', 'response', 60, FALSE, 'high', TRUE, '8-5 Weekdays', 'ORG_001', '2023-01-01 00:00:00', '2023-01-01 00:00:00'),
--1 Hour
('SLA_004', 'Priority 2 - Resolution', 'resolution', 480, TRUE, 'high', TRUE, '8-5 Weekdays', 'ORG_001', '2023-01-01 00:00:00', '2023-01-01 00:00:00'),
--8 Hours (1 Business Day)

-- =========================================================
-- MODERATE (Standard Business Support)
-- =========================================================
('SLA_005', 'Priority 3 - Response', 'response', 240, FALSE, 'moderate', TRUE, '8-5 Weekdays', 'ORG_001', '2023-01-01 00:00:00', '2023-01-01 00:00:00'),
--4 Hours
('SLA_006', 'Priority 3 - Resolution', 'resolution', 1440, TRUE, 'moderate', TRUE, '8-5 Weekdays', 'ORG_001', '2023-01-01 00:00:00', '2023-01-01 00:00:00'),
--3 Business Days (approx)

-- =========================================================
-- LOW (Best Effort / Long Term)
-- =========================================================
('SLA_007', 'Priority 4 - Response', 'response', 1440, FALSE, 'low', TRUE, '8-5 Weekdays', 'ORG_001', '2023-01-01 00:00:00', '2023-01-01 00:00:00'),
--1 Business Day
('SLA_008', 'Priority 4 - Resolution', 'resolution', 2880, TRUE, 'low', TRUE, '8-5 Weekdays', 'ORG_001', '2023-01-01 00:00:00', '2023-01-01 00:00:00'); 
-- 5 Business Days
...
-- Mapping 3: [State: NEW]
-- Switch Port Dead (INC_051 - In Progress) -> Re-cabling Project (CHG_008 - New)
('CRM_003', 'CHG_008', 'INC_051', NULL, 'ORG_001', '2025-12-03 12:00:00', '2025-12-03 12:00:00'),

-- Mapping 4: [State: ASSESS]
-- VPN Timeout (INC_025 - Resolved/Recurring) -> VPN Firmware Upgrade (CHG_005 - Assess)
('CRM_004', 'CHG_005', 'INC_025', NULL, 'ORG_001', '2025-12-03 11:00:00', '2025-12-03 11:00:00'),

-- Mapping 5: [State: AUTHORIZE]
-- Core Switch Failure (INC_003 - In Progress) -> Replace Line Card (CHG_002 - Authorize)
('CRM_005', 'CHG_002', 'INC_003', NULL, 'ORG_001', '2025-12-03 09:00:00', '2025-12-03 09:00:00'),

-- Mapping 6: [State: SCHEDULED]
-- SAP Major Outage (INC_001 - In Progress) -> Apply Oracle Patch (CHG_001 - Scheduled)
('CRM_006', 'CHG_001', 'INC_001', NULL, 'ORG_001', '2025-12-03 10:30:00', '2025-12-03 10:30:00'),

-- Mapping 7: [State: IMPLEMENT]
-- HR DB Error (INC_057 - New) -> Deploy HR Portal v2.0 (CHG_006 - Implement)
('CRM_007', 'CHG_006', 'INC_057', NULL, 'ORG_001', '2025-12-03 14:00:00', '2025-12-03 14:00:00'),

-- Mapping 8: [State: REVIEW]
-- Robot Halted (INC_004 - On Hold) -> Firmware Rollback (CHG_003 - Review)
...
INSERT INTO incident_knowledge (incident_kb_id, incident_id, knowledge_id, used_as, created_on) VALUES

-- =============================================================================
-- 1. PASSWORD & ACCESS (High Volume - High Success Rate)
-- KB_001 (Password Reset) & KB_004 (Account Lockout)
-- =============================================================================
('IKB_001', 'INC_001', 'KB_004', 'resolution', '2025-12-01 10:05:00'),
--Password Reset (Closed)
('IKB_002', 'INC_007', 'KB_004', 'resolution', '2025-12-03 08:20:00'),
--Account Locked (Closed)
('IKB_003', 'INC_010', 'KB_001', 'resolution', '2025-11-25 14:10:00'),
--Password Reset (Resolved)
('IKB_004', 'INC_041', 'KB_001', 'resolution', '2025-11-01 09:05:00'),
--Password Reset (Closed)
('IKB_005', 'INC_059', 'KB_001', 'resolution', '2025-11-05 09:05:00'),
--Password Reset (Closed)
('IKB_006', 'INC_078', 'KB_001', 'resolution', '2025-11-07 09:05:00'),
--Password Reset (Closed)
('IKB_007', 'INC_085', 'KB_001', 'resolution', '2025-11-09 09:05:00'),
--Password Reset (Resolved)
('IKB_008', 'INC_091', 'KB_001', 'resolution', '2025-11-11 09:05:00'),
--Password Reset (Resolved)
('IKB_009', 'INC_100', 'KB_001', 'resolution', '2025-11-15 09:05:00'),
--Password Reset (Closed)

-- =============================================================================
-- 2. VPN ISSUES (KB_003 - Error 412 Fix)
-- =============================================================================
('IKB_010', 'INC_002', 'KB_003', 'applied', '2025-12-03 08:15:00'),
-- VPN Failure (In Progress)
('IKB_011', 'INC_005', 'KB_003', 'suggested', '2025-11-20 09:05:00'),
--VPN Login (Resolved)
('IKB_012', 'INC_025', 'KB_003', 'resolution', '2025-11-28 15:00:00'),
--VPN Timeout (Resolved)
('IKB_013', 'INC_062', 'KB_003', 'applied', '2025-11-28 10:15:00'),
-- VPN Slow (Resolved)
('IKB_014', 'INC_093', 'KB_003', 'applied', '2025-12-03 10:35:00'),
-- VPN 691 (In Progress)

-- =============================================================================
-- 3. PRINTER ISSUES (KB_013 - Tray 2 Jam)
-- =============================================================================
('IKB_015', 'INC_003', 'KB_013', 'resolution', '2025-12-02 14:00:00'),
--Printer Jam (Resolved)
('IKB_016', 'INC_012', 'KB_013', 'resolution', '2025-11-28 12:00:00'),
--Printer Jammed (Resolved)
('IKB_017', 'INC_015', 'KB_013', 'suggested', '2025-12-03 11:05:00'),
--Printer Offline (New)

-- =============================================================================
-- 4. EMAIL & OUTLOOK (KB_007 - Sync Issues)
-- =============================================================================
('IKB_018', 'INC_004', 'KB_007', 'suggested', '2025-12-03 11:05:00'),
--Outlook Not Syncing (New)
('IKB_019', 'INC_017', 'KB_007', 'applied', '2025-12-03 08:50:00'),
-- Outlook Delayed (In Progress)
('IKB_020', 'INC_048', 'KB_007', 'resolution', '2025-11-25 13:30:00'),
--Mobile Email Error (Resolved)

-- =============================================================================
-- 5. SAP ERP ISSUES (KB_006 - Session Locked)
-- =============================================================================
('IKB_021', 'INC_016', 'KB_006', 'resolution', '2025-11-30 10:30:00'),
--Session Locked (Resolved)
('IKB_022', 'INC_044', 'KB_006', 'suggested', '2025-12-03 08:20:00'),
--SAP Slow (In Progress)
('IKB_023', 'INC_084', 'KB_006', 'resolution', '2025-11-30 10:30:00'),
--SAP Lock (Resolved)
...
-- =============================================================================
('IKB_024', 'INC_011', 'KB_016', 'applied', '2025-12-01 09:30:00'),
-- Battery Swelling (In Progress)
('IKB_025', 'INC_079', 'KB_016', 'suggested', '2025-12-03 09:35:00'),
--Laptop Fan Noise (New) - *Maybe related*
('IKB_026', 'INC_013', 'KB_014', 'suggested', '2025-12-03 09:35:00'),
--Docking Station (New)
('IKB_027', 'INC_027', 'KB_014', 'resolution', '2025-11-20 15:00:00'),
--ThinkPad Dock (Resolved)
('IKB_028', 'INC_081', 'KB_014', 'suggested', '2025-12-03 09:35:00'),
--Docking Issue (New)

-- =============================================================================
-- 7. ZOOM / TEAMS (KB_008 - Audio Not Working)
-- =============================================================================
('IKB_029', 'INC_018', 'KB_008', 'resolution', '2025-11-29 14:15:00'),
--Teams Camera (Resolved)
('IKB_030', 'INC_032', 'KB_008', 'suggested', '2025-11-26 15:10:00'),
--Zoom Update (Resolved)
('IKB_031', 'INC_076', 'KB_008', 'suggested', '2025-12-03 10:05:00'),
--Zoom Freeze (New)

-- =============================================================================
-- 8. SOFTWARE (Salesforce, Adobe, Excel)
-- =============================================================================
('IKB_032', 'INC_019', 'KB_009', 'suggested', '2025-12-03 11:15:00'),
--Salesforce Perms (New)
('IKB_033', 'INC_070', 'KB_009', 'suggested', '2025-12-03 11:20:00'),
--Salesforce Error (New)
('IKB_034', 'INC_020', 'KB_010', 'resolution', '2025-11-25 09:30:00'),
--Adobe License (Resolved)
('IKB_035', 'INC_066', 'KB_011', 'resolution', '2025-11-25 15:15:00'),
--Excel Macro (Resolved)
('IKB_036', 'INC_026', 'KB_011', 'applied', '2025-12-03 09:50:00'),
-- Excel Crashing (In Progress)

-- =============================================================================
-- 9. WIFI & NETWORK (KB_017 - Guest WiFi)
-- =============================================================================
('IKB_037', 'INC_008', 'KB_017', 'suggested', '2025-12-03 11:35:00'),
--Cannot Connect WiFi (New)
('IKB_038', 'INC_055', 'KB_017', 'resolution', '2025-11-25 10:30:00'),
--Guest WiFi Down (Resolved)
('IKB_039', 'INC_012', 'KB_019', 'suggested', '2025-12-02 14:05:00'),
--Core Switch (Alert) - *URL Whitelist suggested by AI erroneously*

-- =============================================================================
-- 10. MFA & SECURITY (KB_002 - MFA Setup)
-- =============================================================================
('IKB_040', 'INC_009', 'KB_002', 'resolution', '2025-11-29 10:00:00'),
--MFA Reset (Resolved)
('IKB_041', 'INC_017', 'KB_002', 'suggested', '2025-11-30 14:05:00'),
--MFA Token (Resolved)
('IKB_042', 'INC_076', 'KB_002', 'applied', '2025-12-03 10:10:00'),
-- MFA (In Progress)

-- =============================================================================
-- 11. BITLOCKER (KB_012)
-- =============================================================================
('IKB_043', 'INC_049', 'KB_012', 'applied', '2025-12-03 09:10:00'),
-- Locked Out/Crypto (In Progress) - Agent checking keys
('IKB_044', 'INC_020', 'KB_012', 'suggested', '2025-12-03 09:05:00'),
--Crypto Wallet (New)

-- =============================================================================
-- 12. PHONE (KB_015 - Static)
-- =============================================================================
('IKB_045', 'INC_035', 'KB_015', 'applied', '2025-12-02 13:15:00');
