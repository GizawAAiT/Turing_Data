...
-- Generated on: 2025-10-29T04:53:33.843367
...
('techcorp-001', 'team_techcorp_001', 'NOTE_52191d41-ce2d-4295-a477-b75941bd8e0f', '2025-10-26', NULL, '{"contentType": "text", "content": "Team standup at 10 AM. Code review session at 2 PM. Remember to update sprint board."}', datetime('now'), datetime('now'), 0),
('techcorp-001', 'team_techcorp_001', 'NOTE_d011e056-5f78-4020-98b2-84ef6f71d008', '2025-10-27', '{"contentType": "text", "content": "Sprint planning meeting at 11 AM - still being finalized"}', NULL, datetime('now'), datetime('now'), 0),
('techcorp-001', 'team_techcorp_001', 'NOTE_a1b2c3d4-e5f6-4789-abcd-ef1234567890', '2025-10-28', '{"contentType": "text", "content": "Demo day preparation - need to finalize presentation"}', '{"contentType": "text", "content": "Demo day preparation. Product demo at 3 PM for stakeholders."}', datetime('now'), datetime('now'), 0),
('techcorp-001', 'team_techcorp_001', 'NOTE_12345678-90ab-cdef-1234-567890abcdef', '2025-10-29', NULL, '{"contentType": "text", "content": "Team retrospective at 10 AM. Come prepared with feedback from the sprint."}', datetime('now'), datetime('now'), 0),
('techcorp-001', 'team_techcorp_001', 'NOTE_abcdef12-3456-7890-abcd-ef1234567890', '2025-11-04', '{"contentType": "text", "content": "Release day - version 2.0. Deployment checklist in progress."}', NULL, datetime('now'), datetime('now'), 0),
('globalex-002', 'team_globalex_002', 'NOTE_aaaabbbb-cccc-dddd-eeee-ffff00001111', '2025-10-27', NULL, '{"contentType": "text", "content": "Q4 Sales kickoff meeting at 9 AM. Review quarterly targets and strategies."}', datetime('now'), datetime('now'), 0),
('globalex-002', 'team_globalex_002', 'NOTE_11112222-3333-4444-5555-666677778888', '2025-10-28', '{"contentType": "text", "content": "Client presentations - agenda being updated"}', '{"contentType": "text", "content": "Client presentations scheduled throughout the day. Check calendar for specific times."}', datetime('now'), datetime('now'), 0),
('globalex-002', 'team_globalex_002', 'NOTE_99998888-7777-6666-5555-444433332222', '2025-10-31', '{"contentType": "text", "content": "Team building activity planned - details TBD"}', NULL, datetime('now'), datetime('now'), 0),
('globalex-002', 'team_globalex_002', 'NOTE_fedcba09-8765-4321-fedc-ba0987654321', '2025-11-02', NULL, '{"contentType": "text", "content": "Performance review day. Individual meetings scheduled. Check your calendar for your slot."}', datetime('now'), datetime('now'), 0);
...
('87c65d45-1fde-4d65-95c7-ea9ff9e7ca9d', 'meeting_NjQ2NmFjOWQtMjM3Yi00YmU1LWE4MjUtZmNlOTM0YzJmMmY1', '1615971548136', '2021-03-17T09:05:00.000+00:00'),
('bc933f3a-7278-4649-99e6-a29513d02d59', 'meeting_OWE4MjNmOTYtNzBhNC00NzZhLWE5NDItM2Q1ZGE2NzI4NDVl', '1614618259349', '2021-03-01T17:10:00.000+00:00');
...
('incoming-test-call-001', 'techcorp-001', 'https://bot.techcorp.com/api/calls', 'b6776281-19b8-406f-857c-44bc626609cd', 'incoming', 'incoming', 'Test Redirect Call 001', '{"identity": {"user": {"id": "bob.smith", "displayName": "Bob Smith", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}', '[{"identity": {"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}]', '00945737-9547-41d5-ae9b-6ffa1e5f595d', '["audio", "video"]', '{"isContentSharingNotificationEnabled": true}', '{"_odata_type": "#microsoft.graph.serviceHostedMediaConfig"}', datetime('now'), datetime('now'), 0),
('incoming-test-call-002', 'techcorp-001', 'https://bot.techcorp.com/api/calls', 'a14e074d-662c-4e16-8fbf-4378f307b195', 'incoming', 'incoming', 'Test Redirect Call 002', '{"identity": {"user": {"id": "carol.white", "displayName": "Carol White", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}', '[{"identity": {"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}]', 'f5c6277f-3523-4004-b9e1-b67ac3b0f061', '["audio"]', '{}', '{"_odata_type": "#microsoft.graph.serviceHostedMediaConfig"}', datetime('now'), datetime('now'), 0),
('incoming-test-call-003', 'techcorp-001', 'https://bot.techcorp.com/api/calls', '67a8f1ba-15d1-47b3-bb5b-1dd98573eba3', 'incoming', 'incoming', 'Test Redirect Call 003', '{"identity": {"phone": {"id": "+14255551234"}}}', '[{"identity": {"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}]', 'aa1ce576-9c82-4852-8547-8686d354bd08', '["audio"]', '{}', '{"_odata_type": "#microsoft.graph.serviceHostedMediaConfig"}', datetime('now'), datetime('now'), 0),
('incoming-test-call-004', 'techcorp-001', 'https://bot.techcorp.com/api/calls', 'f248192a-bd33-4eaa-9e27-d563e2939091', 'incoming', 'incoming', 'Test Redirect Call 004', '{"identity": {"user": {"id": "dave.brown", "displayName": "Dave Brown", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}', '[{"identity": {"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}]', '6d105c71-3b0f-4988-a5f3-170bb382da52', '["audio", "video"]', '{}', '{"_odata_type": "#microsoft.graph.serviceHostedMediaConfig"}', datetime('now'), datetime('now'), 0),
('incoming-test-call-005', 'techcorp-001', 'https://bot.techcorp.com/api/calls', 'c7fb7987-b927-416b-887f-5dd6ac90bc44', 'incoming', 'incoming', 'Test Redirect Call 005', '{"identity": {"user": {"id": "bob.smith", "displayName": "Bob Smith", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}', '[{"identity": {"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}]', '34cbfa05-86ff-45ea-8673-91c1a0f15202', '["audio"]', '{}', '{"_odata_type": "#microsoft.graph.serviceHostedMediaConfig"}', datetime('now'), datetime('now'), 0),
('incoming-test-call-006', 'techcorp-001', 'https://bot.techcorp.com/api/calls', 'efde2df6-468a-47b7-a9eb-00cbd13814b4', 'incoming', 'incoming', 'Test Redirect Call 006', '{"identity": {"user": {"id": "carol.white", "displayName": "Carol White", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}', '[{"identity": {"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}]', '3a6c5873-4e2f-40a3-887b-88fd0c6783a0', '["audio"]', '{}', '{"_odata_type": "#microsoft.graph.serviceHostedMediaConfig"}', datetime('now'), datetime('now'), 0),
('incoming-test-call-007', 'techcorp-001', 'https://bot.techcorp.com/api/calls', 'fe6b0dda-52a1-4c1d-835a-b831bdc1b4d8', 'incoming', 'incoming', 'Test Redirect Call 007', '{"identity": {"user": {"id": "dave.brown", "displayName": "Dave Brown", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}', '[{"identity": {"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}]', '86b1db1c-cbec-4de0-9471-4ca360fd7844', '["audio"]', '{}', '{"_odata_type": "#microsoft.graph.serviceHostedMediaConfig"}', datetime('now'), datetime('now'), 0),
('incoming-test-call-008', 'techcorp-001', 'https://bot.techcorp.com/api/calls', 'c042988e-ebb2-4862-9803-02a4701c152a', 'incoming', 'incoming', 'Test Redirect Call 008', '{"identity": {"user": {"id": "bob.smith", "displayName": "Bob Smith", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}', '[{"identity": {"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}]', '29ed59c4-403b-4766-a139-493c37954c2e', '["audio"]', '{}', '{"_odata_type": "#microsoft.graph.serviceHostedMediaConfig"}', datetime('now'), datetime('now'), 0),
('incoming-test-call-009', 'techcorp-001', 'https://bot.techcorp.com/api/calls', '907ca41e-e55b-4f20-b35a-b6f9c08a2590', 'incoming', 'incoming', 'Test Redirect Call 009', '{"identity": {"user": {"id": "carol.white", "displayName": "Carol White", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}', '[{"identity": {"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}]', 'f9361bf5-794b-4e20-9881-8078d43baeea', '["audio"]', '{}', '{"_odata_type": "#microsoft.graph.serviceHostedMediaConfig"}', datetime('now'), datetime('now'), 0),
('incoming-test-call-010', 'techcorp-001', 'https://bot.techcorp.com/api/calls', '95cac4a7-9c6d-4c37-8d15-40ed935e9f47', 'incoming', 'incoming', 'Test Redirect Call 010', '{"identity": {"user": {"id": "dave.brown", "displayName": "Dave Brown", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}', '[{"identity": {"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}]', '5eac9970-11cd-4b3d-8212-ee5b81c4589d', '["audio"]', '{}', '{"_odata_type": "#microsoft.graph.serviceHostedMediaConfig"}', datetime('now'), datetime('now'), 0),
('incoming-test-call-011', 'techcorp-001', 'https://bot.techcorp.com/api/calls', '64b567a1-1deb-48a9-8133-240eb692ffec', 'incoming', 'incoming', 'Test Redirect Call 011', '{"identity": {"user": {"id": "bob.smith", "displayName": "Bob Smith", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}', '[{"identity": {"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}]', '2d65f0ce-85a0-4453-a7e3-a1cdb8247fe3', '["audio"]', '{}', '{"_odata_type": "#microsoft.graph.serviceHostedMediaConfig"}', datetime('now'), datetime('now'), 0),
('incoming-test-call-012', 'techcorp-001', 'https://bot.techcorp.com/api/calls', 'dd3c2fc7-69a4-44a7-bbb1-b25e4709e5f0', 'incoming', 'incoming', 'Test Redirect Call 012', '{"identity": {"user": {"id": "carol.white", "displayName": "Carol White", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}', '[{"identity": {"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}]', '8b383f6d-6180-4a0c-8a65-3551e0ff1e07', '["audio"]', '{}', '{"_odata_type": "#microsoft.graph.serviceHostedMediaConfig"}', datetime('now'), datetime('now'), 0),
...
('57af5b7e-1f93-4f46-a8d4-b8c0e5f3a7d2', 'techcorp-001', 'https://bot.techcorp.com/callback', '210fe177-3d27-4cd1-9f57-3d0df6df4d77', 'outgoing', 'established', 'Project Alpha Discussion', '{"identity": {"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}', '[{"identity": {"user": {"id": "bob.smith", "displayName": "Bob Smith", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}]', '08ce13c8-37c8-4a86-971c-8db9a21d8ccf', '["audio", "video"]', '{"isContentSharingNotificationEnabled": true, "isDeltaRosterEnabled": true, "recordingStatus": "notRecording"}', '{"_odata_type": "#microsoft.graph.serviceHostedMediaConfig"}', datetime('now'), datetime('now'), 0),
('a1b2c3d4-5e6f-7a8b-9c0d-1e2f3a4b5c6d', 'techcorp-001', 'https://bot.contoso.com/api/calls', '3fd7d014-e584-410f-9090-5ab6d7256333', 'outgoing', 'established', 'Design Review Meeting', '{"identity": {"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}', '[{"identity": {"user": {"id": "bob.smith", "displayName": "Bob Smith", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}, {"identity": {"user": {"id": "carol.white", "displayName": "Carol White", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}]', '36c1cc43-9d74-4023-acb8-25837696e2ee', '["audio", "video", "videoBasedScreenSharing"]', '{"isContentSharingNotificationEnabled": true, "isDeltaRosterEnabled": true, "recordingStatus": "notRecording"}', '{"_odata_type": "#microsoft.graph.serviceHostedMediaConfig"}', datetime('now'), datetime('now'), 0),
('8c9d0e1f-2a3b-4c5d-6e7f-8a9b0c1d2e3f', 'globalex-002', 'https://bot.globalex.com/callback', 'a814c9a6-5767-46a0-acbb-2085d5042b84', 'outgoing', 'established', 'Q4 Executive Planning', '{"identity": {"user": {"id": "emma.wilson", "displayName": "Emma Wilson", "tenantId": "f9e8d7c6-b5a4-3210-9876-543210fedcba"}}}', '[{"identity": {"user": {"id": "frank.chen", "displayName": "Frank Chen", "tenantId": "f9e8d7c6-b5a4-3210-9876-543210fedcba"}}}, {"identity": {"user": {"id": "grace.kim", "displayName": "Grace Kim", "tenantId": "f9e8d7c6-b5a4-3210-9876-543210fedcba"}}}]', '643917b9-34df-441c-877b-2bee7072c9cf', '["audio", "video"]', '{"isContentSharingNotificationEnabled": true, "isDeltaRosterEnabled": true, "recordingStatus": "recording", "recordingStatusUpdatedAt": "2025-10-29T04:48:33.850487+00:00"}', '{"_odata_type": "#microsoft.graph.appHostedMediaConfig", "blob": "eyJjb25maWd1cmF0aW9uIjp7Im1lZGlhU2Vzc2lvbiI6eyJhdWRpbyI6dHJ1ZSwidmlkZW8iOnRydWV9fX0="}', datetime('now'), datetime('now'), 0),
('3f4a5b6c-7d8e-9f0a-1b2c-3d4e5f6a7b8c', 'techcorp-001', 'https://bot.techcorp.com/callback', 'c1f377f3-5d82-4934-ab2b-7aae3a662f26', 'incoming', 'terminated', 'Design Review Call', '{"identity": {"user": {"id": "dave.brown", "displayName": "Dave Brown", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}', '[{"identity": {"user": {"id": "carol.white", "displayName": "Carol White", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890"}}}]', '7a7b8397-e38f-4ede-ad49-46af1e1ea630', '["audio"]', '{"recordingStatus": "notRecording"}', '{"_odata_type": "#microsoft.graph.serviceHostedMediaConfig"}', datetime('now'), datetime('now'), 0);
...
('e523d2ed-2966-4b6b-925b-754a88034cc5', 'techcorp-001', 1, 'peerToPeer', '["audio"]', '{"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890", "userPrincipalName": "alice.manager@techcorp.com"}}', '[{"id": "c408ee24-7c40-4429-8f71-c02b46eb8a65", "identity": {"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890", "userPrincipalName": "alice.manager@techcorp.com"}}}, {"id": "578db280-97dc-42eb-80f1-71a1770bab2c", "identity": {"user": {"id": "bob.smith", "displayName": "Bob Smith", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890", "userPrincipalName": "bob.smith@techcorp.com"}}}]', '2025-10-24T02:53:33.836Z', '2025-10-24T03:08:33.836Z', '2025-10-24T03:08:33.836Z', 'https://teams.microsoft.com/l/meetup-join/e523d2ed-2966-4b6b-925b-754a88034cc5', '2025-10-24T02:53:33.836Z', '2025-10-24T03:08:33.836Z'),
('f8a3b1c9-4d7e-4a2f-9c5d-6e8b9f0a1b2c', 'techcorp-001', 1, 'groupCall', '["audio", "video", "videoBasedScreenSharing"]', '{"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890", "userPrincipalName": "alice.manager@techcorp.com"}}', '[{"id": "75a19fe8-5b73-4f70-ac44-b64efcd4a1f2", "identity": {"user": {"id": "alice.johnson", "displayName": "Alice Johnson", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890", "userPrincipalName": "alice.manager@techcorp.com"}}}, {"id": "1751b75f-1c53-4d1a-9668-2b6c1b4fbf9a", "identity": {"user": {"id": "bob.smith", "displayName": "Bob Smith", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890", "userPrincipalName": "bob.smith@techcorp.com"}}}, {"id": "b99f0189-3005-4235-ad01-e2fbaf80101a", "identity": {"user": {"id": "carol.white", "displayName": "Carol White", "tenantId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890", "userPrincipalName": "carol.white@techcorp.com"}}}]', '2025-10-26T01:53:33.836Z', '2025-10-26T02:53:33.836Z', '2025-10-26T02:53:33.836Z', 'https://teams.microsoft.com/l/meetup-join/f8a3b1c9-4d7e-4a2f-9c5d-6e8b9f0a1b2c', '2025-10-26T01:53:33.836Z', '2025-10-26T02:53:33.836Z'),
('a1b2c3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d', 'globalex-002', 1, 'peerToPeer', '["audio"]', '{"user": {"id": "frank.chen", "displayName": "Frank Chen", "tenantId": "f9e8d7c6-b5a4-3210-9876-543210fedcba", "userPrincipalName": "frank.chen@globalex.com"}}', '[{"id": "7dcee910-0762-41fb-8126-87a53a4c0748", "identity": {"user": {"id": "frank.chen", "displayName": "Frank Chen", "tenantId": "f9e8d7c6-b5a4-3210-9876-543210fedcba", "userPrincipalName": "frank.chen@globalex.com"}}}, {"id": "acda1dab-2ae0-431c-9b50-4ccbbcf0d69a", "identity": {"user": {"id": "emma.wilson", "displayName": "Emma Wilson", "tenantId": "f9e8d7c6-b5a4-3210-9876-543210fedcba", "userPrincipalName": "emma.wilson@globalex.com"}}}]', '2025-10-27T01:53:33.836Z', '2025-10-27T02:03:33.836Z', '2025-10-27T02:03:33.836Z', 'https://teams.microsoft.com/l/meetup-join/a1b2c3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d', '2025-10-27T01:53:33.836Z', '2025-10-27T02:03:33.836Z'),
('d5e6f7a8-b9c0-4d1e-2f3a-4b5c6d7e8f9a', 'globalex-002', 1, 'groupCall', '["audio", "video"]', '{"user": {"id": "emma.wilson", "displayName": "Emma Wilson", "tenantId": "f9e8d7c6-b5a4-3210-9876-543210fedcba", "userPrincipalName": "emma.wilson@globalex.com"}}', '[{"id": "f5c1c148-05f2-4615-ae20-3cab6729ebed", "identity": {"user": {"id": "emma.wilson", "displayName": "Emma Wilson", "tenantId": "f9e8d7c6-b5a4-3210-9876-543210fedcba", "userPrincipalName": "emma.wilson@globalex.com"}}}, {"id": "26ceb3d2-6b45-4cff-98ac-8e1effcf4921", "identity": {"user": {"id": "frank.chen", "displayName": "Frank Chen", "tenantId": "f9e8d7c6-b5a4-3210-9876-543210fedcba", "userPrincipalName": "frank.chen@globalex.com"}}}, {"id": "4ae7cf5c-12c4-4ac7-b54a-b2a17e2ee87a", "identity": {"user": {"id": "grace.kim", "displayName": "Grace Kim", "tenantId": "f9e8d7c6-b5a4-3210-9876-543210fedcba", "userPrincipalName": "grace.kim@globalex.com"}}}, {"id": "8c59d180-dc08-4aa2-b80a-731434013423", "identity": {"user": {"id": "henry.lopez", "displayName": "Henry Lopez", "tenantId": "f9e8d7c6-b5a4-3210-9876-543210fedcba", "userPrincipalName": "henry.lopez@globalex.com"}}}]', '2025-10-28T00:53:33.836Z', '2025-10-28T01:53:33.836Z', '2025-10-28T01:53:33.836Z', 'https://teams.microsoft.com/l/meetup-join/d5e6f7a8-b9c0-4d1e-2f3a-4b5c6d7e8f9a', '2025-10-28T00:53:33.836Z', '2025-10-28T01:53:33.836Z');
...
('56611d6b-8691-40a6-94e5-cf8a81467bbd', 'techcorp-001', 1, 'pstn', '[]', '{}', '[{"id": "56611d6b-8691-40a6-94e5-cf8a81467bbd", "org_id": "techcorp-001", "callId": "1835317186_112562680@61.221.3.176", "userId": "alice.johnson", "userPrincipalName": "alice.manager@techcorp.com", "userDisplayName": "Alice Johnson", "startDateTime": "2025-10-27T01:53:33.850902+00:00", "endDateTime": "2025-10-27T02:08:33.850909+00:00", "duration": 900, "charge": 2.5, "callType": "user_out", "currency": "USD", "calleeNumber": "+1234567890", "usageCountryCode": "US", "tenantCountryCode": "US", "connectionCharge": 0.1, "callerNumber": "+10123456789", "destinationContext": null, "destinationName": "United States", "conferenceId": null, "licenseCapability": "MCOPSTNU", "inventoryType": "Subscriber", "operator": "Microsoft", "callDurationSource": "microsoft"}]', '2025-10-27T01:53:33.850902+00:00', '2025-10-27T02:08:33.850909+00:00', NULL, '2025-10-27T01:53:33.850902+00:00', '2025-10-27T02:08:33.850909+00:00'),
('48ceb0d9-8a13-4f96-a29b-ca998318af73', 'techcorp-001', 1, 'pstn', '[]', '{}', '[{"id": "48ceb0d9-8a13-4f96-a29b-ca998318af73", "org_id": "techcorp-001", "callId": "1835317187_112562681@61.221.3.177", "userId": "bob.smith", "userPrincipalName": "bob.smith@techcorp.com", "userDisplayName": "Bob Smith", "startDateTime": "2025-10-27T23:53:33.850921+00:00", "endDateTime": "2025-10-28T00:03:33.850925+00:00", "duration": 600, "charge": 0.0, "callType": "user_in", "currency": "USD", "calleeNumber": "+10123456788", "usageCountryCode": "US", "tenantCountryCode": "US", "connectionCharge": 0.0, "callerNumber": "+1234567891", "destinationContext": null, "destinationName": "United States", "conferenceId": null, "licenseCapability": "MCOPSTNU", "inventoryType": "Subscriber", "operator": "Microsoft", "callDurationSource": "microsoft"}]', '2025-10-27T23:53:33.850921+00:00', '2025-10-28T00:03:33.850925+00:00', NULL, '2025-10-27T23:53:33.850921+00:00', '2025-10-28T00:03:33.850925+00:00'),
('88261f03-8777-4350-a64f-54f1b3a1e994', 'globalex-002', 1, 'pstn', '[]', '{}', '[{"id": "88261f03-8777-4350-a64f-54f1b3a1e994", "org_id": "globalex-002", "callId": "1835317188_112562682@61.221.3.178", "userId": "emma.wilson", "userPrincipalName": "emma.wilson@globalex.com", "userDisplayName": "Emma Wilson", "startDateTime": "2025-10-26T02:53:33.850933+00:00", "endDateTime": "2025-10-26T03:13:33.850936+00:00", "duration": 1200, "charge": 5.8, "callType": "user_out", "currency": "CAD", "calleeNumber": "+442071234567", "usageCountryCode": "GB", "tenantCountryCode": "CA", "connectionCharge": 0.2, "callerNumber": "+14165551234", "destinationContext": "International", "destinationName": "United Kingdom", "conferenceId": null, "licenseCapability": "MCOPSTNU", "inventoryType": "Subscriber", "operator": "Microsoft", "callDurationSource": "microsoft"}]', '2025-10-26T02:53:33.850933+00:00', '2025-10-26T03:13:33.850936+00:00', NULL, '2025-10-26T02:53:33.850933+00:00', '2025-10-26T03:13:33.850936+00:00'),
('8929bc51-c29a-4b02-9910-e72784da93bd', 'globalex-002', 1, 'pstn', '[]', '{}', '[{"id": "8929bc51-c29a-4b02-9910-e72784da93bd", "org_id": "globalex-002", "callId": "1835317189_112562683@61.221.3.179", "userId": "frank.chen", "userPrincipalName": "frank.chen@globalex.com", "userDisplayName": "Frank Chen", "startDateTime": "2025-10-29T01:53:33.850945+00:00", "endDateTime": "2025-10-29T02:38:33.850949+00:00", "duration": 2700, "charge": 0.0, "callType": "conf_in", "currency": "CAD", "calleeNumber": "+14165551235", "usageCountryCode": "CA", "tenantCountryCode": "CA", "connectionCharge": 0.0, "callerNumber": "+14165559999", "destinationContext": null, "destinationName": "Canada", "conferenceId": "conf_2024_001", "licenseCapability": "MCOPSTNU", "inventoryType": "Subscriber", "operator": "Microsoft", "callDurationSource": "microsoft"}]', '2025-10-29T01:53:33.850945+00:00', '2025-10-29T02:38:33.850949+00:00', NULL, '2025-10-29T01:53:33.850945+00:00', '2025-10-29T02:38:33.850949+00:00');

-- Direct Routing Call Logs (as call_records with type='direct_routing')
INSERT INTO call_records (id, org_id, version, type, modalities, organizer, participants, start_date_time, end_date_time, join_web_url, created_at, updated_at) VALUES
('8151f78a-b712-481b-8347-d9e02217ea19', 'techcorp-001', 1, 'direct_routing', '[]', '{}', '[{"id": "8151f78a-b712-481b-8347-d9e02217ea19", "org_id": "techcorp-001", "correlationId": "400a4d8e-53f2-4688-a6a6-7bb12ca6982a", "userId": "alice.johnson", "userPrincipalName": "alice.manager@techcorp.com", "userDisplayName": "Alice Johnson", "startDateTime": "2025-10-27T01:53:33.851013+00:00", "inviteDateTime": "2025-10-27T01:53:28.851018+00:00", "failureDateTime": "0001-01-01T00:00:00Z", "endDateTime": "2025-10-27T02:05:33.851036+00:00", "duration": 720, "callType": "ByotOut", "successfulCall": true, "callerNumber": "+14255551001", "calleeNumber": "+14255559876", "mediaPathLocation": "USWE", "signalingLocation": "USEA", "finalSipCode": 200, "callEndSubReason": 0, "finalSipCodePhrase": "OK", "trunkFullyQualifiedDomainName": "sbc.techcorp.com", "mediaBypassEnabled": false}]', '2025-10-27T01:53:33.851013+00:00', '2025-10-27T02:05:33.851036+00:00', NULL, '2025-10-27T01:53:33.851013+00:00', '2025-10-27T02:05:33.851036+00:00'),
('368e7417-cbcd-4875-a9ff-c6d2c69884ce', 'techcorp-001', 1, 'direct_routing', '[]', '{}', '[{"id": "368e7417-cbcd-4875-a9ff-c6d2c69884ce", "org_id": "techcorp-001", "correlationId": "deb03987-c1b2-46e5-a669-f77cb33ebd02", "userId": "bob.smith", "userPrincipalName": "bob.smith@techcorp.com", "userDisplayName": "Bob Smith", "startDateTime": "2025-10-27T23:53:33.851052+00:00", "inviteDateTime": "2025-10-27T23:53:30.851056+00:00", "failureDateTime": "0001-01-01T00:00:00Z", "endDateTime": "2025-10-28T00:01:33.851059+00:00", "duration": 480, "callType": "ByotIn", "successfulCall": true, "callerNumber": "+14255552222", "calleeNumber": "+14255551002", "mediaPathLocation": "USWE", "signalingLocation": "USEA", "finalSipCode": 200, "callEndSubReason": 0, "finalSipCodePhrase": "OK", "trunkFullyQualifiedDomainName": "sbc.techcorp.com", "mediaBypassEnabled": true}]', '2025-10-27T23:53:33.851052+00:00', '2025-10-28T00:01:33.851059+00:00', NULL, '2025-10-27T23:53:33.851052+00:00', '2025-10-28T00:01:33.851059+00:00'),
('cd460cd4-678c-4ec7-8c3a-dfd332dc65ba', 'techcorp-001', 1, 'direct_routing', '[]', '{}', '[{"id": "cd460cd4-678c-4ec7-8c3a-dfd332dc65ba", "org_id": "techcorp-001", "correlationId": "eee0e0f5-6c77-4641-a0f2-ff5a47644af9", "userId": "carol.white", "userPrincipalName": "carol.white@techcorp.com", "userDisplayName": "Carol White", "startDateTime": "2025-10-28T02:53:33.851070+00:00", "inviteDateTime": "2025-10-28T02:53:31.851073+00:00", "failureDateTime": "2025-10-28T02:53:18.851075+00:00", "endDateTime": "2025-10-28T02:53:18.851078+00:00", "duration": 0, "callType": "ByotOut", "successfulCall": false, "callerNumber": "+14255551003", "calleeNumber": "+14255557777", "mediaPathLocation": null, "signalingLocation": "USEA", "finalSipCode": 480, "callEndSubReason": 540407, "finalSipCodePhrase": "Temporarily Unavailable", "trunkFullyQualifiedDomainName": "sbc.techcorp.com", "mediaBypassEnabled": false}]', '2025-10-28T02:53:33.851070+00:00', '2025-10-28T02:53:18.851078+00:00', NULL, '2025-10-28T02:53:33.851070+00:00', '2025-10-28T02:53:18.851078+00:00'),
('8e0eca83-3eb9-4e53-8a9d-f418ae74d27b', 'globalex-002', 1, 'direct_routing', '[]', '{}', '[{"id": "8e0eca83-3eb9-4e53-8a9d-f418ae74d27b", "org_id": "globalex-002", "correlationId": "a7b4b9e4-f352-44f9-8a29-621ec0a577bb", "userId": "emma.wilson", "userPrincipalName": "emma.wilson@globalex.com", "userDisplayName": "Emma Wilson", "startDateTime": "2025-10-26T02:53:33.851088+00:00", "inviteDateTime": "2025-10-26T02:53:29.851090+00:00", "failureDateTime": "0001-01-01T00:00:00Z", "endDateTime": "2025-10-26T03:18:33.851093+00:00", "duration": 1500, "callType": "ByotOut", "successfulCall": true, "callerNumber": "+14165552001", "calleeNumber": "+442071234567", "mediaPathLocation": "EUNO", "signalingLocation": "EUNO", "finalSipCode": 200, "callEndSubReason": 0, "finalSipCodePhrase": "OK", "trunkFullyQualifiedDomainName": "sbc.globalex.com", "mediaBypassEnabled": false}]', '2025-10-26T02:53:33.851088+00:00', '2025-10-26T03:18:33.851093+00:00', NULL, '2025-10-26T02:53:33.851088+00:00', '2025-10-26T03:18:33.851093+00:00'),
('6c4ed373-7619-4f87-9319-4bf1fa8287f8', 'globalex-002', 1, 'direct_routing', '[]', '{}', '[{"id": "6c4ed373-7619-4f87-9319-4bf1fa8287f8", "org_id": "globalex-002", "correlationId": "b2dc7a54-180f-4e3a-bc58-a4a52ac445e2", "userId": "frank.chen", "userPrincipalName": "frank.chen@globalex.com", "userDisplayName": "Frank Chen", "startDateTime": "2025-10-29T01:53:33.851103+00:00", "inviteDateTime": "2025-10-29T01:53:27.851105+00:00", "failureDateTime": "0001-01-01T00:00:00Z", "endDateTime": "2025-10-29T02:33:33.851108+00:00", "duration": 2400, "callType": "ByotOut", "successfulCall": true, "callerNumber": "+14165552002", "calleeNumber": "+14165559999", "mediaPathLocation": "USWE", "signalingLocation": "USEA", "finalSipCode": 200, "callEndSubReason": 0, "finalSipCodePhrase": "BYE", "trunkFullyQualifiedDomainName": "sbc.globalex.com", "mediaBypassEnabled": true}]', '2025-10-29T01:53:33.851103+00:00', '2025-10-29T02:33:33.851108+00:00', NULL, '2025-10-29T01:53:33.851103+00:00', '2025-10-29T02:33:33.851108+00:00'),
('972aecb7-857f-47c0-9720-814f37285620', 'globalex-002', 1, 'direct_routing', '[]', '{}', '[{"id": "972aecb7-857f-47c0-9720-814f37285620", "org_id": "globalex-002", "correlationId": "f345bfad-930c-4400-ab83-b5ecb55a013b", "userId": "grace.kim", "userPrincipalName": "grace.kim@globalex.com", "userDisplayName": "Grace Kim", "startDateTime": "2025-10-29T03:53:33.851118+00:00", "inviteDateTime": "2025-10-29T03:53:30.851120+00:00", "failureDateTime": "2025-10-29T03:53:25.851122+00:00", "endDateTime": "2025-10-29T03:53:25.851125+00:00", "duration": 0, "callType": "ByotOut", "successfulCall": false, "callerNumber": "+14165552003", "calleeNumber": "+14165558888", "mediaPathLocation": null, "signalingLocation": "USEA", "finalSipCode": 486, "callEndSubReason": 540486, "finalSipCodePhrase": "Busy Here", "trunkFullyQualifiedDomainName": "sbc.globalex.com", "mediaBypassEnabled": false}]', '2025-10-29T03:53:33.851118+00:00', '2025-10-29T03:53:25.851125+00:00', NULL, '2025-10-29T03:53:33.851118+00:00', '2025-10-29T03:53:25.851125+00:00');
...
('MSo1N2Y5ZGFjYy03MWJmLTQ3NDMtYjQxMy01M2EdFGkdRWHJlQ', 'techcorp-001', 'alice.johnson', 'Team Standup - Project Alpha', '2025-10-27T02:53:33.851Z', '2025-10-27T03:23:33.851Z', '2025-10-24T04:53:33.851Z', 'https://teams.microsoft.com/l/meetup-join/MSo1N2Y5ZGFjYy03MWJmLTQ3NDMtYjQxMy01M2EdFGkdRWHJlQ', '123456789012', 1, 'everyone', 'enabled', 1, 0, NULL, datetime('now'), datetime('now')),
('MSpkYzE3Njc0Yy04MWQ5LTRhZGItYmZ', 'techcorp-001', 'bob.smith', 'Sprint Planning - Q4', '2025-10-28T01:53:33.851Z', '2025-10-28T02:53:33.851Z', '2025-10-22T04:53:33.851Z', 'https://teams.microsoft.com/l/meetup-join/MSpkYzE3Njc0Yy04MWQ5LTRhZGItYmZ', '987654321098', 0, 'organization', 'enabled', 1, 1, NULL, datetime('now'), datetime('now')),
('MSoxMjM0NTY3OC05YWJjLTQxZjItYTlkNC1lZjEyMzQ1Njc4OTA', 'globalex-002', 'emma.wilson', 'Executive Leadership Sync', '2025-10-26T00:53:33.851Z', '2025-10-26T01:53:33.851Z', '2025-10-19T04:53:33.851Z', 'https://teams.microsoft.com/l/meetup-join/MSoxMjM0NTY3OC05YWJjLTQxZjItYTlkNC1lZjEyMzQ1Njc4OTA', '555666777888', 1, 'organizer', 'enabled', 0, 1, NULL, datetime('now'), datetime('now'));
...
('MSMjMCMjZDAwYWU3NjUtNmM2Yi00NjQxLTgwMWQtMTkzMmFmMjEzNzdh', 'techcorp-001', 'MSo1N2Y5ZGFjYy03MWJmLTQ3NDMtYjQxMy01M2EdFGkdRWHJlQ', 'af630fe0-04d3-4559-8cf9-91fe45e36296', '2025-10-27T02:53:33.851Z', '2025-10-27T03:23:33.851Z', 'bc842d7a-2f6e-4b18-a1c7-73ef91d5c8e3', 'https://graph.microsoft.com/v1.0/$metadata#users(''alice.johnson'')/onlineMeetings(''MSo1N2Y5ZGFjYy03MWJmLTQ3NDMtYjQxMy01M2EdFGkdRWHJlQ'')/transcripts/(''MSMjMCMjZDAwYWU3NjUtNmM2Yi00NjQxLTgwMWQtMTkzMmFmMjEzNzdh'')/content', 'WEBVTT
...
('MSMjMCMjMzAxNjNhYTctNWRmZi00MjM3LTg5MGQtNWJhYWZjZTZhNWYw', 'techcorp-001', 'MSo1N2Y5ZGFjYy03MWJmLTQ3NDMtYjQxMy01M2EdFGkdRWHJlQ', 'af630fe0-04d3-4559-8cf9-91fe45e36296', '2025-10-24T02:53:33.851Z', '2025-10-24T03:23:33.851Z', 'bc842d7a-2f6e-4b18-a1c7-73ef91d5c8e3', 'https://graph.microsoft.com/v1.0/$metadata#users(''alice.johnson'')/onlineMeetings(''MSo1N2Y5ZGFjYy03MWJmLTQ3NDMtYjQxMy01M2EdFGkdRWHJlQ'')/transcripts/(''MSMjMCMjMzAxNjNhYTctNWRmZi00MjM3LTg5MGQtNWJhYWZjZTZhNWYw'')/content', 'WEBVTT
...
('MSMjMCMjNzU3ODc2ZDYtOTcwMi00MDhkLWFkNDItOTE2ZDNmZjkwZGY4', 'techcorp-001', 'MSpkYzE3Njc0Yy04MWQ5LTRhZGItYmZ', 'bf730fe1-05d4-4660-9dfa-a2fe46e37397', '2025-10-28T01:53:33.851Z', '2025-10-28T02:53:33.851Z', 'cd953e8b-3g7f-5c29-b2d8-84fg02e6d9f4', 'https://graph.microsoft.com/v1.0/$metadata#users(''bob.smith'')/onlineMeetings(''MSpkYzE3Njc0Yy04MWQ5LTRhZGItYmZ'')/transcripts/(''MSMjMCMjNzU3ODc2ZDYtOTcwMi00MDhkLWFkNDItOTE2ZDNmZjkwZGY4'')/content', 'WEBVTT
...
('MSMjMCMjOGI5YzNkNGUtNmY3YS00NWU4LWI2YzEtMjM0NTY3ODkwYWJj', 'globalex-002', 'MSoxMjM0NTY3OC05YWJjLTQxZjItYTlkNC1lZjEyMzQ1Njc4OTA', 'cg840gf2-06e5-5771-aeea-b3gf57f48408', '2025-10-26T00:53:33.851Z', '2025-10-26T01:53:33.851Z', 'de064f9c-4h8g-6d3a-c3e9-95hg13f7eag5', 'https://graph.microsoft.com/v1.0/$metadata#users(''emma.wilson'')/onlineMeetings(''MSoxMjM0NTY3OC05YWJjLTQxZjItYTlkNC1lZjEyMzQ1Njc4OTA'')/transcripts/(''MSMjMCMjOGI5YzNkNGUtNmY3YS00NWU4LWI2YzEtMjM0NTY3ODkwYWJj'')/content', 'WEBVTT
...
('techcorp-001', 'a57082a9-7629-4f74-8da0-8d621aab4d2d@4aa05bcc-1cac-4a83-a9ae-0db84b88f4ba', 'The Impact of Tech on Our Lives', 'text', 'Discusses how technology has changed the way we communicate.', '2025-11-05T10:00:00+00:00', 'Pacific Standard Time', '2025-11-05T17:00:00+00:00', 'Pacific Standard Time', 'organization', 'draft', 'alice.johnson', 'Alice Johnson', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 0, '[]', datetime('now'), datetime('now')),
('globalex-002', 'b68193ba-8730-5f85-9eb1-9e732bbc5c3e@5bb16cdd-2dbd-5b94-bbbf-1eb95ccd99g5ba', 'Future of Remote Work', 'html', '<p>Exploring the trends and tools shaping remote work in 2024 and beyond.</p>', '2025-11-12T14:00:00+00:00', 'UTC', '2025-11-12T16:30:00+00:00', 'UTC', 'everyone', 'draft', 'emma.wilson', 'Emma Wilson', 'f9e8d7c6-b5a4-3210-9876-543210fedcba', 1, '[]', datetime('now'), datetime('now'));
...
('techcorp-001', 'bce9a3ca-a310-48fa-baf3-1cedcd04bb3f@4aa05bcc-1cac-4a83-a9ae-0db84b88f4ba', 'Company All-Hands Meeting', 'text', 'Quarterly update and town hall for all employees', '2025-11-08T09:00:00+00:00', 'UTC', '2025-11-08T10:30:00+00:00', 'UTC', 'organization', 0, 'draft', 'alice.johnson', 'Alice Johnson', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 1, '[]', datetime('now'), datetime('now')),
('globalex-002', 'c79204cb-b421-59gb-cac4-2defde05cc4g@6cc27dee-3ece-6c05-cccg-2fc06dde00h6cb', 'Executive Strategy Session', 'text', 'Q2 strategy planning for leadership team only', '2025-11-19T15:00:00+00:00', 'Pacific Standard Time', '2025-11-19T17:00:00+00:00', 'Pacific Standard Time', 'organization', 1, 'draft', 'emma.wilson', 'Emma Wilson', 'f9e8d7c6-b5a4-3210-9876-543210fedcba', 0, '[]', datetime('now'), datetime('now'));
